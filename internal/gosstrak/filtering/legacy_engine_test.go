...
func BenchmarkFilterLegacy1000Tags100Subs(b *testing.B) {
	benchmarkFilterLegacyNTagsNSubs(1000, 100, b)
}
...
func BenchmarkFilterLegacy100Tags1000Subs(b *testing.B) {
	benchmarkFilterLegacyNTagsNSubs(100, 1000, b)
}
